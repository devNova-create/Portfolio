...
- Email: 201134shubhamyadav@gmail.com   
- Location: Thane, India  
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/shubham-yadav-77a47032a)  
- GitHub: [GitHub](https://github.com/devNova-create)  
- Instagram: [Instagram](#) (To be updated later)
...
```bash
git clone https://github.com/devNova-create/portfolio-showcase.git
